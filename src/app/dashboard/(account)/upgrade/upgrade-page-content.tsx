...
const UpgradePlanPageContent = ({ plan }: { plan: Plan }) => {
    ...
    <div className="max-w-3xl flex flex-col gap-8">
      <div>
        ...
        <p className="text-sm/6 text-gray-600 max-w-prose">
          {plan === "PRO"
            ? "Thank you for supporting PandaProbe. Find your increased usage limits below."
...
export default UpgradePlanPageContent
